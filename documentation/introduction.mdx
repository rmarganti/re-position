...
<img alt="Example Usage" src={require('./re-position.gif')} />
...
benefit from the ease of `PositionableContainer`. It is an absolutely positioned
container (a `div` by default) that you can use right out of the box. It provides
